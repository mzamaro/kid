...
<?php 
$enviado = $d->current()->enviado;
if ($enviado == '1'){
?>
    
 <td colspan="2"><img src="enviado.png" title="enviado ok" alt="envio registro" border="0"><a href="#" onclick="deleterow(<?php echo $d->current()->id; ?>)"><img src="delete.png" title="Deletar registro" alt="Deletar registro" border="0" /></a></td>
<?php  
}else{
?> 
 <td ><a href="#" onclick="deleterow(<?php echo $d->current()->id; ?>)"><img src="delete.png" title="Deletar registro" alt="Deletar registro" width="16" height="16" border="0" /></a></td>
        ...
        <div id="informacoes-2">        
            ...
            <p>Selecione o modelo do convite:</p>
             <form action="" method="post">   
               <a href="visualizaconvitesbc.php"><img src="imagem/kidsbcthumb.jpg" border="0" /></a>     
                <a href="visualizaconvitejardim.php"><img src="imagem/verdethumb.jpg" border="0" /></a>
             <!--<a href="vconvite_lounge.php"><img src="lounge/kidlounge.jpg"  border="0" /></a>-->

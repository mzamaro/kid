...
<br>
<font face="Tahoma, Geneva, sans-serif" size="3" color="#FF0099" style="margin-left:40px;">'.$nome.'</font>                            
       ...
       $quant = 3;
         ...
         $sql = mysql_query("SELECT ". $campos ." FROM ". $tabela ." WHERE idniver = ".$id." AND codStatus = 0 LIMIT ". $inicio .",". $quant)or die(mysql_error());
           ...
           while($r = mysql_fetch_array($sql)){
            ...
            echo '<p>Convite enviado para: '. $para .' Ok<br /></p></div>';
                ...
                echo '<p>Convite não enviado para: '. $para .'</p>';

...
$confirmando = mysql_query("UPDATE contatos set confirma = 'nao'  WHERE id = '$id'")or die("Erro na consulta".mysql_error());
...
if($scliente == ''){
  ...
  $assunto = "Confirmação de ausência na festa de " .$nome. "";
  $msgn .= "Confirmação de ausência na festa de " .$nome. "<br /><br />";
		$msgn .= "O convidado ".$nomeconv."<br /><br />";
		$msgn .= "E-mail: ".$email."<br /><br />";
		$msgn .= "Confirmou que não poderá ir a sua festa!<br /><br />";	
        $msgn .= "Dia " .$newdia. " as " .$horas. "hrs no Kid Beeruta ".$unidade."!<br /><br />";

    $remetente = "convite@kidbeerutabuffet.com.br";
	...
	if(!$phpmail->Send()){
	 echo'<div id="alert">Erro ao enviar mensagem!</div>';
       ...
       echo("<script type='text/javascript'> alert('Que pena :( , fica para proxima então, obrigado !!!'
